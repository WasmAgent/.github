...
| ⚙️ [claude-bot](https://github.com/telleroutlook/claude-bot) | Internal automation — issue triage, PR review, and cross-repo coherence patrol (not a public product) |
